...
public class SetAchievementProgressFunction extends BaseFunction {

	@Override
	public FREObject call( FREContext context, FREObject[] args ) {
		super.call( context, args );

		// No such API in Google Play Games

		AIR.dispatchEvent( GameServicesEvent.ACHIEVEMENT_UPDATE_ERROR, "Setting achievement progress is not supported on Android." );
